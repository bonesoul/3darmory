...
class DataUpload
{
  private static final String FIELD_NAME = "fileupload";
  private String boundary;
  private static final String uploadURL="http://www.imageshack.us/upload_api.php?rembar=yes&tags=3DArmory&key=HLY7ZUPS379c38c0025305f6b5040c35f164cb78";
  private HttpURLConnection connection;
  private DataOutputStream output;
  //private static final String SCRIPT_NAME = "upload_screenshot";
  //private static final String BASE_URL = "http://devel.pimpmyepix.com";

  
  DataUpload()
  {
    // Mime boundary of the various parts of the message.
    boundary = "-----3DArmoryToonUploader-----3DArmory-----" + System.currentTimeMillis();
